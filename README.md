...
|----------------|------------------------|
| ❌ Suporte remoto (horas para resposta) | ✅ **Suporte LOCAL em Natal/RN** (resposta em minutos!) |
| ❌ Cupom só por impressora térmica | ✅ **Cupom por WhatsApp** + impressora |
| ❌ CPF/CNPJ opcional | ✅ **CPF/CNPJ obrigatório** no cupom fiscal |
| ❌ Pagamento único | ✅ **Pagamento misto** (Dinheiro + PIX + Cartão) |
| ❌ Troco manual | ✅ **Troco calculado automaticamente** |
| ❌ R$ 99/mês | ✅ **R$ 49/mês** (lançamento) |

> 💡 **Diferencial competitivo:** Enquanto concorrentes de SP demoram horas para responder, eu aqui de Natal respondo em **minutos** via WhatsApp!
...
### 🛒 Vendas Inteligentes
- ✅ Pagamento fracionado (Dinheiro + PIX + Cartão na mesma venda)
- ✅ Cálculo automático de troco
- ✅ Busca por código de barras ou nome do produto
- ✅ Atalhos de teclado (F2 para nova venda, ESC para cancelar)

### 📄 Cupom Fiscal Profissional
- ✅ Número de série padrão fiscal (`111-XXXXXX`)
- ✅ CPF/CNPJ do cliente no cupom
- ✅ Nome do operador responsável
- ✅ Envio **automático por WhatsApp** com 1 clique
- ✅ Layout otimizado para papel térmico (80mm)

### 💵 Gestão de Caixa
- ✅ Abertura/fechamento de caixa com relatório Z
- ✅ Sangria autorizada apenas por administrador
- ✅ Suprimento de troco
- ✅ Relatório diário automático no fechamento
...
### 👥 Multi-Operadores
- ✅ Administrador (acesso total + sangria)
...
├── 📄 sales.html          # PDV com WhatsApp integrado
├── 📄 cash-open.html      # Abertura de caixa
├── 📄 cash-close.html     # Fechamento de caixa
...
👉 **Dica:** Depois de fazer deploy, tire 3 prints reais do sistema e substitua os links `https://via.placeholder.com/...` pelas URLs das imagens no seu repositório.

---

onal!**

Quer que eu gere também um **banner personalizado** para o topo do README com logo do Tanque Digital? 🎨
